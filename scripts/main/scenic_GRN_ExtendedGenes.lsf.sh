...
# Replace YOUR_LSF_PROJECT with the account configured for your cluster.
...
#BSUB -W 90:00
#BSUB -R span[hosts=1]
#BSUB -o 2026_08_GRN_ExtendedGenes.out
#BSUB -oo 2026_08_GRN_ExtendedGenes.stdout
#BSUB -eo 2026_08_GRN_ExtendedGenes.stderr
# Replace the address below or remove the BMAIL directives.
#BMAIL -u your.email@example.org
#BMAIL -N
#BMAIL -B
...
FIGURE_CODES_DIR="${ICH_PROJECT_DIR:?Set ICH_PROJECT_DIR to the project directory}"
